...
function prod() {
    ...
    gulp.task('js', function () {
        return gulp.src([Config.js.src, '!./src/js/zepto.min.js', '!./src/js/weui.min.js', '!./src/js/TouchSlide.1.1.js']).pipe(jshint('.jshintrc')).pipe(jshint.reporter('default')).pipe(gulp.dest(Config.js.dist)).pipe(rename({
            suffix: '.min'
